...
```
conda create -n UdEst python=3.13
conda activate UdEst
```
...
pip install "cogent3==2026.7.30a0" "cogent3_h5seqs==0.7.3" -U
```
Please check that the package versions are cogent3==2026.7.30a0, cogent3_h5seqs==0.7.3 and ensembl_tui==0.7.7 using
```
pip freeze
```
...
We sample alignments with ancestral repeat sequences masked using

```
eti alignments -i install -od proximal5_IG --align_name 10_primates* --ref human --mask allAR_1column.txt --ref_coords chrom22_proximal5_IG_coordinates.tsv
```
...
```
eti alignments -i install -od distal_IG --align_name 10_primates* --ref human --mask allAR_1column.txt --ref_coords chrom22_distal_IG_coordinates.tsv
```
...
```
eti alignments -i install -od proximal3_IG --align_name 10_primates* --ref human --mask allAR_1column.txt --ref_coords chrom22_proximal3_IG_coordinates.tsv.tsv
```

...
#SBATCH --output=logs/trinuc_filtering_3_%A_%a.out
#SBATCH --error=logs/trinuc_filtering_3_%A_%a.err
#SBATCH --array=1-120
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=60gb
...
python3 filtering_trinuc_gaps_nointrons_3.py -reg "$REGION" -chrm "$CHROMOSOME"
#!/bin/bash
#SBATCH --job-name=trinuc_submodel_4
#SBATCH --output=logs_submodel/trinuc_submodel_4_%A_%a.out
#SBATCH --error=logs_submodel/trinuc_submodel_4_%A_%a.err
#SBATCH --array=1-216
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=120gb
...
python3 fittinglh_trinucmodel_4.py -reg "$REGION" -chrm "$CHROMOSOME"

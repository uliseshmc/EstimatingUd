...
#This is the original function stated by Gavin
def modified_lf(lf):
...
#Here on are function I wrote. Delete them if I don't need them. I am not sure if they are useful. I will keep them for now.
...
def modified_lf_Ulisesmodified(lf_Q, lf_f0_lengths):
    """return a new likelihood function with the fitted parameter rules
